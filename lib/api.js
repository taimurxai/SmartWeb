...
export const api = {
  ...
  adminResetDevice: (id) => request(`/api/admin/users/${id}/reset-device`, { method: "POST" }),
  ...
  adminCleanData: (data) => request("/api/admin/clean", { method: "POST", body: JSON.stringify(data) }),
};
